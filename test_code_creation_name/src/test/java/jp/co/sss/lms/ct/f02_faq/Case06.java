...
public class Case06 {
	...
	void test05() {
		...
		String categoryText = "【研修関係】";
		pageLoadTimeout(60);
		// カテゴリ検索 click
		WebElement categoryname = driver.findElement(By.linkText(categoryText));
		categoryname.click();
		...
		for (int i = 0; i < count; i++) {
			assertEquals(categoryQuestionTxt[i], results.get(i).getText());
		}
